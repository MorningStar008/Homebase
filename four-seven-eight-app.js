...
const circleRemove = document.querySelector(".circle-remove");
...
// Grow/Shrink Circle
const growCircle = () => {
  document.getElementById("circle").style.transition = "4s ease all";
  circleProgress.classList.add("circle-grow");
  setTimeout(() => {
    document.getElementById("circle").style.transition = "8s ease all";
